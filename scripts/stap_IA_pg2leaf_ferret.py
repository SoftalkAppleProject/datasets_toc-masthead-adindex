...
#
# Step 1. From the Collection homepage, get a sorted list of all 48 issues of Softalk...
#
...
for index, issueURL in enumerate(issues):
    ...
    for page in pageData:
        ...
        if pgType != "Color Card":
            pg2leaf_spec.append([issue_spec[0], issue_spec[1], issue_spec[2], issue_spec[3], page.find('pageType').text, page.get('leafNum'),  pageNumber])
    print('### Next Issue ###')
#
# Step 3. Generate the Pg2Leaf CSV file...
#
print('##############################')
...
if no_file_export:
    ...
    with open(output_dir + '/softline_pg2leaf_all.csv', 'w', newline='') as mycsvfile:
        ...
        thedatawriter.writerow(["Vol", "No", "Month", "Year", "PageType", "LeafNum", "PgNum"])
